...
- Floating window / NSPanel / SpriteKit + mouse-interaction rows — **shipped in Phase 04** (see [`phase-04-floating-pet.md`](phase-04-floating-pet.md)); was deferred at Phase 03 planning time.
...
- **Floating window / NSPanel / SpriteKit and the mouse-interaction rows** (codex rows 1 `running-right`, 2 `running-left`, 4 `jumping`). **Shipped in Phase 04** — see [`phase-04-floating-pet.md`](phase-04-floating-pet.md). At Phase 03 planning time these rows were reserved in the contract and unmapped in the menu bar renderer until the float surface existed.
