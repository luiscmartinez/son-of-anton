...
- **Eight-condition checklist is the ground truth.** The runbook and log are keyed to the eight exit conditions in `docs/product/plans/phase-01-cli-convex-plumbing.md`. If those change, both files change in lockstep.
