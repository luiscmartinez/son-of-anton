...
- Treat empty output from an otherwise successful runner as an honest non-clean result. Use an explicit termination/outcome representation rather than letting it fall through to fake clean.
...
- Verify the "empty output" case cannot be represented as a clean completed review.
