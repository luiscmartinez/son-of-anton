...
Ticket: P1.02 IPC contract — animation state vocabulary
Branch: agents/p1-02-ipc-contract-animation-state-vocabulary
Base branch: agents/p1-01-repo-skeleton
Worktree: /Users/cesar/code/codogotchi_p1_02

## Required Reads

- `docs/template/overview/start-here.md`
- `docs/product/delivery/phase-01/implementation-plan.md`
- `docs/product/delivery/phase-01/ticket-02-ipc-contract.md`
...
- Previous ticket: `P1.01 Repo skeleton`
- Previous branch: `agents/p1-01-repo-skeleton`
- Previous PR: https://github.com/cesarnml/codogotchi/pull/2
- Review outcome: `clean`
- Review fetch artifact: `docs/product/delivery/phase-01/reviews/P1.01-ai-review.fetch.json`
- Review triage artifact: `docs/product/delivery/phase-01/reviews/P1.01-ai-review.triage.json`
