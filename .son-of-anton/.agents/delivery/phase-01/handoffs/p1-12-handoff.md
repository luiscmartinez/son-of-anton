...
Ticket: P1.12 CLI scaffold + setup command
Branch: agents/p1-12-cli-scaffold-setup-command
Base branch: agents/p1-11-source-wakatime
Worktree: /Users/cesar/code/codogotchi_p1_12

## Required Reads

- `docs/template/overview/start-here.md`
- `docs/product/delivery/phase-01/implementation-plan.md`
- `docs/product/delivery/phase-01/ticket-12-cli-setup.md`
...
- Previous ticket: `P1.11 Source: Wakatime`
- Previous branch: `agents/p1-11-source-wakatime`
- Previous PR: https://github.com/cesarnml/codogotchi/pull/12
- Review outcome: `clean`
- Review fetch artifact: `docs/product/delivery/phase-01/reviews/P1.11-ai-review.fetch.json`
- Review triage artifact: `docs/product/delivery/phase-01/reviews/P1.11-ai-review.triage.json`
